...
<input type="hidden" type="text" name="vec1" value="
	<?php
	 	for ($i=0; $i < $tam-1; $i++) { 
		print_r($array1[$i]."-");
	}
?>">	
<input type="hidden" type="text" name="vec2" value="
	<?php 		
	for ( $r = 0 ; $r < $tam-1; $r++ ){		
		print_r($array2[$r]."-");
		}?>
		">
<br>			
<input type="hidden" type="text" name="vec3" value="
	<?php 		
	for ( $r = 0 ; $r < $tam-1; $r++ ){		
		print_r($array3[$r]."-");
		}?>
